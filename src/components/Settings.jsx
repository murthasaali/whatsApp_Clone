...
function Settings({theme}) {
  ...
  return (
    <div className={`${theme==="dark"?"bg-white text-stone-900":"bg-black text-stone-300"} w-full h-full  px-4 flex flex-col gap-3`}>
      ...
      <h1 className={`${theme==="dark"?"text-green-600 ":"text-white "} text-xl font-bold h-fit`}>Settings</h1>
      </nav>
      ...
      <div className='flex w-full p-3 gap-6  rounded-xl justify-start items-center'>
